...
{
    public partial class loginCn : Form
    {
        ...
        public loginCn(string account)
        {
            InitializeComponent();
        }

        public loginCn(string account, string pwd)
        {
            InitializeComponent();
        ...
        private void loginCn_Load(object sender, EventArgs e)
        {
