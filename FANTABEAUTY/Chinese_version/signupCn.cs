...
{
    public partial class signupCn : Form
    {
        ...
        public signupCn(string phone, string id, string code, string birthday, string money, string gender, string comments)
        {
            InitializeComponent();
            this.phoneVal = phone;
            this.idVal = id;
        ...
        private void signupCn_Load(object sender, EventArgs e)
        {
        ...
        {
            this.Hide();
            new English_version.signup().Show();
        }
    }
}
